...
<Text style={{color:'black',fontWeight:'900',fontSize:17,marginTop:25,marginLeft:85}}>Contact Info</Text>
    </View>
    ...
    <Image 
       ...
       <View  style={{height:1,backgroundColor:'black',opacity:0.3,marginTop:10}}    />
       ...
       <View  style={{height:1,backgroundColor:'black',opacity:0.3,marginTop:10}}    />
        ...
        <View style={{flexDirection:'column',marginHorizontal:20}}> 
        <Text style={{color:'black' ,fontSize:18}}>warren.buff@invest.ai  </Text>
       <View  style={{height:1,backgroundColor:'black',opacity:0.3,marginTop:10}}    />
